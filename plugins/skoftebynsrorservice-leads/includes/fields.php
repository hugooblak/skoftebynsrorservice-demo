...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'skoftebynsrorservice-leads' ),
				'storm'       => __( 'Storm or hail damage', 'skoftebynsrorservice-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'skoftebynsrorservice-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'skoftebynsrorservice-leads' ),
				'not-sure'    => __( 'Vet inte än', 'skoftebynsrorservice-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'skoftebynsrorservice-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'skoftebynsrorservice-leads' ),
				'research' => __( 'Jag kollar bara priser', 'skoftebynsrorservice-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'skoftebynsrorservice-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'skoftebynsrorservice-leads' ),
		'contacted' => __( 'Kontaktad', 'skoftebynsrorservice-leads' ),
		'quoted'    => __( 'Quote sent', 'skoftebynsrorservice-leads' ),
		'won'       => __( 'Won', 'skoftebynsrorservice-leads' ),
		'lost'      => __( 'Lost', 'skoftebynsrorservice-leads' ),
		'spam'      => __( 'Misstänkt spam', 'skoftebynsrorservice-leads' ),
	);
}
