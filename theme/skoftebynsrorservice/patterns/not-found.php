...
/**
 * Title: Not found
 * Slug: skoftebynsrorservice/not-found
...
<div class="wp-block-button sk-track-cta"><a class="wp-block-button__link wp-element-button" href="<?php echo $url( '/free-quote/' ); ?>">Boka besiktning</a></div>
<!-- /wp:button -->
