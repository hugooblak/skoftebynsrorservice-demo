<?php
/**
 * Skoftebyns rörservice theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Skoftebyns rörservice Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through sk_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'skoftebynsrorservice', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'skoftebynsrorservice' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'skoftebynsrorservice' ) ) );

		register_block_pattern_category( 'skoftebynsrorservice-sections', array( 'label' => __( 'Skoftebyns rörservice sections', 'skoftebynsrorservice' ) ) );
		register_block_pattern_category( 'skoftebynsrorservice-pages', array( 'label' => __( 'Skoftebyns rörservice page layouts', 'skoftebynsrorservice' ) ) );
	}
);
